...
metadata {
	definition (name: "Xiaomi Aqara Motion Sensor (AQ2)", namespace: "jayly", author: "a4refillpad") {
    	...
    	fingerprint profileId: "0104", inClusters: "0000, FFFF, 0406, 0400", outClusters: "0000, 0019", manufacturer: "LUMI", model: "lumi.sensor_motion.aq2", deviceJoinName: "Xiaomi Motion"
...
private Map parseIlluminanceMessage(String description)
{
	...
	def value = ((description - "illuminance: ").trim()) as Integer
